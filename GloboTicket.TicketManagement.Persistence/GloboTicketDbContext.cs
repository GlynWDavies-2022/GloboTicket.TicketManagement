...
public class GloboTicketDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Order>().HasData(new Order
        {
            ...
            OrderTotal = 135,
            OrderPaid = true,
            OrderPlaced = new DateTime(2025, 4, 2),
        ...
        modelBuilder.Entity<Order>().HasData(new Order
        {
            ...
            OrderTotal = 85,
            OrderPaid = true,
            OrderPlaced = new DateTime(2025, 4, 3),
        ...
        modelBuilder.Entity<Order>().HasData(new Order
        {
            ...
            OrderTotal = 245,
            OrderPaid = true,
            OrderPlaced = new DateTime(2025, 4, 4),
        ...
        modelBuilder.Entity<Order>().HasData(new Order
        {
            ...
            OrderTotal = 142,
            OrderPaid = true,
            OrderPlaced = new DateTime(2025, 4, 5),
        ...
        modelBuilder.Entity<Order>().HasData(new Order
        {
            ...
            OrderTotal = 40,
            OrderPaid = true,
            OrderPlaced = new DateTime(2025, 4, 6),
        ...
        modelBuilder.Entity<Order>().HasData(new Order
        {
            ...
            OrderTotal = 116,
            OrderPaid = true,
            OrderPlaced = new DateTime(2025, 4, 7),
            UserId = Guid.Parse("{7AEB2C01-FE8E-4B84-A5BA-330BDF950F5C}")
        });
    }
